...
public class TierCutTester {
	...
	public static void main(String args[]) throws ClassNotFoundException {
		...
		Configuration conf = new Configuration(
				Configuration.readProperties(TierCutTester.class
						.getResourceAsStream("jobs/Connect4/Connect4_54.job")));
		...
		System.out.println("Only Last Tier Cut "
				+ (game.numHashes() - game.numHashesForTier(tiers - 1)));
		...
		try {
			...
			tcDb = new TierCutDatabase(null, conf, 0, game.numHashes(),
					reading, writing);
