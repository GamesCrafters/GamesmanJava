...
public class SquareTest {
    ...
    for(int size = 1; size < 6; size++) {      
      ...
      for(int i = 0; i < size*size; i++) {
        if(answer[i] != points[i])
          System.out.print(answer[i] - points[i] + " ");
        else
          System.out.print(". ");
      }
      System.out.println("\n");
  ...
  private static int[] getCorrectFixedPoints(int size) {
    int[] f1 = {0};
    ...
    int[] f5 = {24,23,23,23,23,19,19,19,19,15,15,15,15,11,11,11,11,11,11,11,11,3,3,3,3};
  ...
  private static int[][] getCorrectBoardIndices(int size) {
    int[][] b1 = {{0}};
    ...
    int[][] b7 = {{0 ,4 ,12,20,13,5 ,1 }, 
                  {11,24,28,36,29,25,6 }, 
                  {19,35,40,44,41,30,14},  
                  {23,39,47,48,45,37,21},  
                  {18,34,43,46,42,31,15},  
                  {10,27,33,38,32,26,7 }, 
                  {3 ,9 ,17,22,16,8 ,2 }};
