...
public class HDFSSplitDatabase extends SplitDatabase {
	...
	/**
	 * @param uri
	 *            The file (on HDFS) containing the database headers for this split
	 *            database
	 * @param conf
	...
	public HDFSSplitDatabase(String uri, Configuration conf,
		...
		super(HDFSInfo.getHDFS().open(new Path(uri)), conf, firstRecordIndex,
				numRecords, reading, writing, true);
