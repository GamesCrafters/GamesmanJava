...
/**
 * A mutable pair is a simple data type that stores two (not final) distinct
 * pieces of information
 * 
 * @author Steven Schlansker
 * 
 * @param <A>
 *            The type of the first part
 * @param <B>
 *            The type of the second part
 */
public class MutablePair<A, B> implements Serializable {
	 ...
	 * @return A collection of pairs containing the respective elements of each
	 *         collection.
	 */
	public static <A, B> Collection<Pair<A, B>> zip(Collection<A> a,
			Collection<B> b) {
