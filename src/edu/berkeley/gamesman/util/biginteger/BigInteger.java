...
package edu.berkeley.gamesman.util.biginteger;
 ...
 * (&gt;&gt;&gt;) is omitted, as this operation makes little sense in
 * combination with the "infinite word size" abstraction provided by this class.
 * <p>
 * Semantics of bitwise logical operations exactly mimic those of Java's bitwise
 * integer operators. The binary operators (<tt>and</tt>, <tt>or</tt>,
 * <tt>xor</tt>) implicitly perform sign extension on the shorter of the two
 * operands prior to performing the operation.
 * <p>
 ...
 * <tt>(i + j)</tt> is shorthand for "a BigInteger whose value is that of the
 * BigInteger <tt>i</tt> plus that of the BigInteger <tt>j</tt>." The
 * pseudo-code expression <tt>(i == j)</tt> is shorthand for "<tt>true</tt> if
 * and only if the BigInteger <tt>i</tt> represents the same value as the
 * BigInteger <tt>j</tt>." Other pseudo-code expressions are interpreted
 * similarly.
 * <p>
...
public class BigInteger extends Number implements Comparable<BigInteger> {
	 ...
	 * <tt>mag[0]</tt>) must be non-zero. This is necessary to ensure that there
	 ...
	 * @throws NumberFormatException
	 *             <tt>val</tt> is not a valid representation of a BigInteger in
	 *             the specified radix, or <tt>radix</tt> is outside the range
	 ...
	 * @throws NumberFormatException
	 *             <tt>val</tt> is not a valid representation of a BigInteger.
	 * @see Character#digit
	 */
	 ...
	 *            prime number will exceed <tt>(1 - 1/2<sup>certainty</sup></tt>
	 ...
	 * to a (<code>long</code>) constructor because it allows for reuse of
	 ...
	 * @throws ArithmeticException
	 *             <tt> m &lt;= 0</tt>, or this BigInteger has no multiplicative
	...
	/**
	 * Returns a BigInteger whose value is equivalent to this BigInteger with
	 * the designated bit cleared. (Computes <tt>(this &amp; ~(1&lt;&lt;n))</tt>
	 * .)
	 * 
	 * @param n
	 ...
	 * analogous to a <a href="http://java.sun.com/docs/books/jls/second_edition/html/conversions.doc.html#25363"
	 ...
	 * similar to the <a href="http://java.sun.com/docs/books/jls/second_edition/html/conversions.doc.html#25363"
	 * ><i>narrowing primitive conversion</i></a> from <code>double</code> to
