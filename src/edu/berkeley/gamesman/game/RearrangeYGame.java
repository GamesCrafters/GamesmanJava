...
/*
 * Equivalent to YGame except it extends RearrangeConnectGame in order
 * to use RearrangeHasher
 */

public final class RearrangeYGame extends RearrangeConnectGame 
{
     ...
     */
    public RearrangeYGame(final Configuration conf) 
    {
        super(conf);
...
//                    }
    ...
    static public void main(final String[] args) throws ClassNotFoundException 
    {
        ...
        game = (RearrangeYGame) conf.getGame();
