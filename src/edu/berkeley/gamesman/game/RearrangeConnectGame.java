...
/*
 * Equivalent to ConnectGame except it uses the RearrangeHasher.
 */
public abstract class RearrangeConnectGame extends RearrangeTierGame {
	protected final RearrangeHasher mmh;
	private int tier;
	 ...
	 */
	public RearrangeConnectGame(Configuration conf) {
		super(conf);
		int boardSize;
		...
		if (this instanceof RearrangeYGame) {
