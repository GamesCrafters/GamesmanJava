 ...
 * must include cases where the last element of the prefix is invalid (ie. if two
 * prefixes have the same invariant, then the set of elements which are invalid
 * following the prefix must be the same for both)
 * 
 * @author dnspies
 * 
